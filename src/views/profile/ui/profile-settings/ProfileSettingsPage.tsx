  ...
  return (
    <Page mt={'36px'}>
      <div className={s.container}>
        <TabsRoot defaultValue={TAB_INFORMATION} onValueChange={onTabChangeHandler}>
          <TabsList className={s.tabList}>
            <TabsTrigger value={TAB_INFORMATION}>{tabNames.generalInformation}</TabsTrigger>
          ...
          {sessionsData && <DevicesTab data={sessionsData} value={'devices'} />}
